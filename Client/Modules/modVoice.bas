...
Public Sub InitServerList(ServerList As TextBox)
    ServerList.Text = RemHst
End Sub
...
Public Function Connect(Socket As Winsock, RmHost As String, RemPort As Long) As Boolean
' Attempts To Open A Socket Connection
    ...
    Call Socket.Connect(RmHost, RemPort)       ' Connect To Server
